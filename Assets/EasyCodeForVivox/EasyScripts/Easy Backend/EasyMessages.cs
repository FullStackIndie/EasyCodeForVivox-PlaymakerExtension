...
namespace EasyCodeForVivox
{
    public class EasyMessages
    {
        ...
        private static void OnChannelMessageRecieved(IChannelTextMessage channelTextMessage)
        {
        ...
        public void SendDirectMessage(ILoginSession login, string targetID, string message, string stanzaNameSpace = "", string stanzaBody = "")
        {
