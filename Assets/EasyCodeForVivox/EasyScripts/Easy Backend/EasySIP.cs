            ...
            Channel3DProperties channel3DProperties = null)
        {
            ...
            switch (channelType)
            {
                ...
                case ChannelType.Positional:
                    ...
                    channelToken = $"sip:confctl-d-{issuer}.{region}.{hash}-{channelName}{channel3DProperties.ToString()}@{domain}";
                    break;
            }
            return channelToken;
        }
            ...
            Channel3DProperties channel3DProperties = null)
        {
            ...
            switch (channelType)
            {
                ...
                case ChannelType.Positional:
                    ...
                    channelToken = $"sip:confctl-d-{issuer}.{channelName}{channel3DProperties.ToString()}@{domain}";
                    break;
            }
            return channelToken;
        }
